...
if text == (database:get(bot_id.."saKen:Name:Bot") or "ميرو") and GetChannelMember(msg) then
Namebot = (database:get(bot_id.."saKen:Name:Bot") or "ميرو")
local namebot = {
'عمغي 🥺💕.',
...
local Name_Bot = (database:get(bot_id.."saKen:Name:Bot") or "ميرو")
